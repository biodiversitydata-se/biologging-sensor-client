        ...
        <section className="home about">
            <div className="container">
                <div className="col-md-offset-1 col-md-10">
                    ...
                    <div className="row" style={{marginBottom: '20px'}}>
                       <h3>About the API</h3>
                       <p className="mt-3">All the data displayed on this website is obtained via the Biologging Open API <a href="http://canmove-dev.ekol.lu.se:8080/biologgingAPI/v1/docs">http://canmove-dev.ekol.lu.se:8080/biologgingAPI/v1/docs</a></p>
                    ...
                    <div className="row">
                       ...
                       <p className="mt-3">Are you a researcher who would like to contribute biologging data? Please contact us.</p>
                    </div>
                </div>
            </div>
        </section>
