            ...
            <div className="container">
                <div className="col-md-offset-1 col-md-10">
                    <div className="row bottom-margin">
                        ...
                        <p>There are three data access levels: Datasets can either be full open access, partial open access or without open access. Find a description of the <a href="https://github.com/biodiversitydata-se/biologging-sensor-datamodel/blob/main/pages/dataset.md#accessrights" target="_blank">access right levels here</a>. The open data can be downloaded in json format from the web client, with files containing information according <a href="https://github.com/biodiversitydata-se/biologging-sensor-datamodel" target="_blank">the biologging datamodel</a>, contained in a zip archive. You can as well retrieve the data directly from the API.</p>
