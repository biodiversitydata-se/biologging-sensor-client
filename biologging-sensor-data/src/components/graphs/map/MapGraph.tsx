    ...
    return (
        <div>
            ...
            {showError ? <ErrorComponent /> :
                ...
                <br />
                <h5>Movement data for a random selection of {NB_LINES} animals (animal IDs in legend). 
                ...
                Use mouse over a position to read GPS coordinates, animal ID, date/time.</h5>
        </div >
    )
}
